...
static int (*bpf_biggest_bits)(__u64 bits, __u16 *bit_array, __u32 array_size) =
...
static int (*bpf_unsafe_helper)(struct bpf_unsafe_ctx *unsafe_ctx) =
	(void *)BPF_FUNC_unsafe_helper;
